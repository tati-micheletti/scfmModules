...
devtools::install_github("PredictiveEcology/SpaDES.tools", ref = "development") # Make sure you have the latest version of reproducible: 0.1.4.9016
...
modules <- list("scfmCrop", "scfmLandcoverInit", "scfmRegime", "scfmDisturbanceDriver", "scfmIgnition", "scfmEscape", "scfmSpread", 
  "ageModule", "mapBurns", "loadYieldTables", "Hanzlik", "strataMapFromVegMap", "scfmHarvest", "stateVars", "birdsAlberta")
...
[ IMPROVE ] Let people chose the district they want from Global. Create a function to bring up the table for that Steve
