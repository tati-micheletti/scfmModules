...
module paramater __pSpread__. The latter option is to facilitate stand alone use, or use outside of the module family __scfm__
...
parameters <- list(
 scfmSpread = list(pSpread=0.24,           #make sure there's some escape to show.
...
Maintains a list of fire sizes with an entry for each burn event, indexed by __as.integer(time(sim))__
This is onlt created is paramater .statsInitialTime is not NA. The event repeats at interval returnInterval.
