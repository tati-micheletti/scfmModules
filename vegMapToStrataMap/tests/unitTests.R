...
test_dir("/Users/stevec/Documents/GitHub/scfmModules/vegMapToStrataMap/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/Users/stevec/Documents/GitHub/scfmModules/vegMapToStrataMap/tests/testthat/test-template.R")
