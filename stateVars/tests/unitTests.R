...
test_dir("/Users/stevec/Dropbox/Courses/7043H16/Lab/Harvesting/stateVars/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/Users/stevec/Dropbox/Courses/7043H16/Lab/Harvesting/stateVars/tests/testthat/test-template.R")
