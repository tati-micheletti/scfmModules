...
doEvent.birdsAlberta = function(sim, eventTime, eventType) {
  switch(
    ...
    init = {
      ...
      sim <- scheduleEvent(sim, P(sim)$.saveInitialTime, "birdsAlberta", "save")
    },
    plot = {
      # ! ----- EDIT BELOW ----- ! #
      # do stuff for this event
    ...
    save = {
      ...
      # e.g.,
      # sim <- scheduleEvent(sim, time(sim) + P(sim)$.saveInterval, "birdsAlberta", "save")
    ...
    event1 = {
      ...
      # e.g.,
      # sim <- scheduleEvent(sim, time(sim) + increment, "birdsAlberta", "templateEvent")
