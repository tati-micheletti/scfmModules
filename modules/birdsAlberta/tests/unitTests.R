...
test_dir("C:/Users/tmichele/GitHub/scfmModules/modules/birdsAlberta/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/tmichele/GitHub/scfmModules/modules/birdsAlberta/tests/testthat/test-template.R")
