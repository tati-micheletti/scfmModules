...
test_dir("/home/tmichele/Documents/GitHub/scfmModules/modules/scfmDisturbanceDriver/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/home/tmichele/Documents/GitHub/scfmModules/modules/scfmDisturbanceDriver/tests/testthat/test-template.R")
